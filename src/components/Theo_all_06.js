...
export default function FullScene({ ...props }) {
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <spotLight ref={spotlight1} position={[0,3,2]} intensity={1} penumbra={1} angle={0.53} lookAt={[0,0,0]} color="#FEDD00" />
      <spotLight ref={spotlight2} position={[0,3,-2]} intensity={1} penumbra={1} angle={0.53} lookAt={[0,0,0]} color="#FEDD00" />
